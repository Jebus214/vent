			...
			if($tipo == "req"){
				...
				if($nr > 0){
					echo "<div class=\"panel-group\" id=\"accordion\" role=\"tablist\" aria-multiselectable=\"true\">
						...
						if(!$result){
							echo "<table class=\"table table-striped table-rubro\">";
							
							echo "<p>NO APLICA </p>";
						}else{
							echo "<table class=\"table table-striped table-rubro\">";
							echo "<tr>";
								echo "<th class=\"text-justify\">Requisitos</th>";
								echo "<th class=\"text-justify\">Original</th>";
								echo "<th class=\"text-justify\">Copias</th>";
								echo "<th class=\"text-justify\">Fundamento Legal</th>";
							echo "</tr>";
						}
						while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							echo "<tr class=\"text-justify\">";
							echo "<td class=\"td-nr\">" . $row['TR_NR'] . "</td>";
							echo "<td class=\"td-ori\">" . $row['TR_OR'] . "</td>";
							echo "<td class=\"td-co\">" . $row['TR_CO'] . "</td>";
					...
					if($nr > 0){
						...
						if(!$result){
							...
							echo "<table class=\"table table-striped table-rubro\">";
							echo "<tr>";
								echo "<th class=\"td-nr\">Requisitos</th>";
								echo "<th class=\"td-ori\">Original</th>";
								echo "<th class=\"td-co\">Copias</th>";
								echo "<th class=\"td-fl\">Fundamento Legal</th>";
							echo "</tr>";
						}
						while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							echo "<tr class=\"text-justify\">";
					 		...
					 		<div class=\"row\">
					 				...
					 				<div class=\"col-sm-3 col-xs-12 col-md-3 col-lg-3\">
										...
										<div class=\"contenedor-pie row\">
											<ul id=\"bannersfooter\">
												<a href=\"http://edomex.gob.mx\" target=\"_blank\"><p class=\"texto-pie text-center-xs\"><img class=\"img-responsivenot\" src=\"images/festadomex.png\" alt=\"\">&nbsp;Portal del Gobierno del Estado de México</p></a>
				 		...
				 		<div class=\"row\">
					 		<div class=\"col-lg-12 col-md-12 hidden-xs hidden-sm\">
					 			<div class=\"aviso-pie\">
						 			...
						 			<p class=\"texto-pie text-center\">
						 				Esta sitio esta optimizado para visualizarse en dispositivos móviles, SmartPhone y Tabletas.
						 			</p>
						 		</div>
